...
interface StudentResultsImportTempRepository
{
    ...
    /**
     * @return list<object{id:int,row_index:int,student_id:?int,exam_number:?string,student_name:?string,branch:?string,major:?string,academic_year:?string,subjects_json:?string,total:?string,average:?string,result:?string,status:string,error:?string}>
     */
