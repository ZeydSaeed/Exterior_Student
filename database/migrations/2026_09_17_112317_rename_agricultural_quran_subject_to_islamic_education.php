...
/**
 * الفرع الزراعي / اختصاص زراعي: استبدال مادة
 * «القران الكريم والتربية الاسلامية» بـ «التربية الاسلامية».
 * درجات الطالب تبقى عبر نفس major_subject_id بعد تحديث subject_id.
 */
return new class extends Migration
{
    private const BRANCH_NAME = 'الزراعي';

    private const MAJOR_NAME = 'زراعي';

    private const OLD_SUBJECT_NAME = 'القران الكريم والتربية الاسلامية';

    private const NEW_SUBJECT_NAME = 'التربية الاسلامية';

    public function up(): void
    {
        $this->remapAgriculturalSubject(self::OLD_SUBJECT_NAME, self::NEW_SUBJECT_NAME);
    }

    public function down(): void
    {
        $this->remapAgriculturalSubject(self::NEW_SUBJECT_NAME, self::OLD_SUBJECT_NAME);
    }

    private function remapAgriculturalSubject(string $fromName, string $toName): void
    {
        if (
