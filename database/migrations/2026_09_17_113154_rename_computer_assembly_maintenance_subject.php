...
/**
 * اختصاص «تجميع وصيانة الحاسوب»: استبدال مادة
 * «صيانة وتجميع الحاسوب» بـ «صيانة الحاسوب».
 * درجات الطالب تبقى عبر نفس major_subject_id بعد تحديث subject_id.
 */
return new class extends Migration
{
    private const BRANCH_NAME = 'الحاسوب وتقنية المعلومات';

    private const MAJOR_NAME = 'تجميع وصيانة الحاسوب';

    private const OLD_SUBJECT_NAME = 'صيانة وتجميع الحاسوب';

    private const NEW_SUBJECT_NAME = 'صيانة الحاسوب';
