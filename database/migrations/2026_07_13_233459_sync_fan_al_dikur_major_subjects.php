...
/**
 * تحديث مواد اختصاص «فن الديكور» تحت «فنون تطبيقية».
 */
return new class extends Migration
{
    ...
    {
        $fromConfig = Config::get('grades_catalog.subjects_decor', []);
    ...
    public function down(): void
    {
        ...
        foreach ($newSubjects as $name) {
            ...
            $stillLinked = Schema::hasTable('major_subjects')
                && DB::table('major_subjects')->where('subject_id', $subjectId)->exists();
            if (! $stillLinked) {
