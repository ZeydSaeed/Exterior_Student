...
@section('content')
    ...
    <div class="modal-backdrop is-visible" id="certificate-modal >
        <div>
            <div class="modal-body">
                <div class="support-paper print-area" contenteditable="true">
                    <div class="form-actions no-print" contenteditable="false">
                        <button type="button" class="btn-primary btn-print" id="certificate-btn-print">
                            طباعة
                        </button>
                        <a href="{{ route('students.index') }}" class="btn-primary btn-close">
                            إغلاق
                        </a>
                    </div>
...
@section('scripts')
    ...
    <script src="{{ url('js/students/certificate.js') }}"></script>
@endsection
