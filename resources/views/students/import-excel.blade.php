...
@section('content')
    <div class="import-excel-wrap">
        ...
        <p class="import-excel-desc">اختر ملف Excel (xlsx أو xls) يحتوي على أعمدة:<br>الرقم الامتحاني، اسم الطالب، اسم الاب، اسم الجد، اللقب، الجنس، التولد، محل الولادة، اسم الام الكامل، الفرع، الاختصاص، العام الدراسي، اخر مدرسة كان فيها الطالب ، رقم الوثيقة، تاريخها، جهة الاصدار.</p>
